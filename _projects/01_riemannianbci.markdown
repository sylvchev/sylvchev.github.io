...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/speller.png" title="P300 speller" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/usetheforce2.png" title="MI setup" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/ssvep.png" title="SSVEP" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row">
    ...
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/geodesic2.png" title="riemannian and euclidean distance" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/MDRM.png" title="MDM classifier" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/tangentspace.png" title="Riemannian and Euclidean distance" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
